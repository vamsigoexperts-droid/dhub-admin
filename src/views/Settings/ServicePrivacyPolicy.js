...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Service Privacy Policy' }];
...
const Terms = () => {
  ...
  const getAllData = async () => {
    ...
    try {
      ...
      toast.error('Failed to fetch Service Privacy Policy data');
    } finally {
      setLoading(false);
    }
  };
  ...
  const updateData = async (type = getCurrentType()) => {
    ...
    try {
      ...
      toast.success(`${tabLabels[activeTab]} Service Privacy Policy updated successfully!`);
    } catch (error) {
      toast.error(
        error.response?.data?.message ||
  ...
  const handleSaveAll = async () => {
    ...
    try {
      ...
      toast.success('All Service Privacy Policy updated successfully!');
    } catch (error) {
      toast.error('Failed to update some Service Privacy Policy');
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <PageContainer title="Service Privacy Policy" description="This is Service Privacy Policy page">
      <Breadcrumb title="Service Privacy Policy" items={BCrumb} />
      <ParentCard title="Service Privacy Policy Management">
        {/* Tabs */}
          ...
          <TabPanel key={type} value={activeTab} index={index}>
            <Box sx={{ mb: 2 }}>
              <Typography variant="h6" gutterBottom>
                {tabLabels[index]} Service Privacy Policy
              </Typography>
            ...
            {loading ? (
              ...
              <CKEditor
                ...
                config={{
                  ...
                  placeholder: `Type ${tabLabels[index]} Service Privacy Policy here...`,
                }}
                disabled={saving}
              />
            )}
