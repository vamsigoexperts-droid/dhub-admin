...
const Rescheduled = () => {
    ...
    const fetchOrders = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                toast.error('Failed to fetch rescheduled orders');
            }
        } catch (error) {
    ...
    const handleFilterChange = (newFilters) => {
        setFilters({ ...newFilters, status: 'rescheduled' });
        setPage(0);
    };
    ...
    return (
        <PageContainer title="Rescheduled Orders" description="Verified partner rescheduled orders">
            <Breadcrumb title="Rescheduled Orders" items={BCrumb} />

            <Container maxWidth="xl">
                <Card elevation={3} sx={{ p: 3 }}>
                    <BookingsNav statuses={verifiedPartnerStatuses} counts={{ rescheduled: totalCount }} />
