...
const Cancelled = () => {
    ...
    return (
        <PageContainer title="Cancelled Orders" description="Verified partner cancelled orders">
            <Breadcrumb title="Cancelled Orders" items={BCrumb} />

            <Container maxWidth="xl">
                <Card elevation={3} sx={{ p: 3 }}>
                    <BookingsNav statuses={verifiedPartnerStatuses} counts={{ cancelled: totalCount }} />
