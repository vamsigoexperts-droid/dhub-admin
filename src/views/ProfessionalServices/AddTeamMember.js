...
const AddTeamMember = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await createTeamMember(providerId, submitData);
            ...
            const message = error.message || 'An error occurred while adding team member';
            toast.error(message);
    ...
    return (
        <PageContainer title="Add Team Member" description="Add a new team member">
            <Breadcrumb title="Add Team Member" items={BCrumb} />
