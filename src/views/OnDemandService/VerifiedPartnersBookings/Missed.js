...
const MissedOrders = () => {
        ...
        renderCell: (params) => (
          <Box sx={{ py: 0.5 }}>
            ...
            <Typography
              variant="caption"
              color="error.main"
              sx={{ fontSize: '0.55rem', lineHeight: 1.1, fontWeight: 500 }}
            >
              ₹{(params.row.customerCompensation / 1000).toFixed(0)}K comp
            </Typography>
          </Box>
        ),
      },
      ...
      },
      {
        ...
        renderCell: (params) => (
          <Box sx={{ py: 0.5 }}>
            ...
            <Box sx={{ mt: 0.2, display: 'flex', alignItems: 'center', gap: 0.5 }}>
              <Typography variant="caption" sx={{ fontSize: '0.55rem' }}>
                Impact:
              </Typography>
              {getQualityImpactChip(params.row.qualityImpactScore)}
            </Box>
          </Box>
        ),
      },
  ...
  return (
    <PageContainer
      ...
      description="Critical premium order recovery with SLA breach Assignment and customer compensation"
    >
