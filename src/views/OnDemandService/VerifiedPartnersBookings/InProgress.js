...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Work In Progress - Verified Partners' }];
...
// Main Work In Progress Component for Verified Partners
const WorkInProgress = () => {
  ...
  return (
    <PageContainer
      title="Work In Progress - Verified Partners"
      description="Monitor and manage premium services currently being performed by verified partners"
    >
      <Breadcrumb title="Work In Progress - Verified Partners" items={BCrumb} />
      ...
      >
        ...
        >
          <Box>
            <Typography variant="h6">Work In Progress - Verified Partners</Typography>
