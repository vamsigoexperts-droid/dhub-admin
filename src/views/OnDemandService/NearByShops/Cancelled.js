...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Cancelled Orders' }];
...
// Main Cancelled Orders Component
const CancelledOrders = () => {
    ...
    try {
      ...
      if (response.data.success && response.data.bookings) {
        const transformedData = response.data.bookings.map((booking) => ({
          ...
          cancelledAt: booking.logModifiedDate
          ...
          cancellationReason:
            booking.rejectedReason || booking.statusTextMessage || 'Cancellation requested',
      ...
      },
      {
        ...
        renderCell: (params) => (
          ...
          >
            ...
            >
              Reason: {params.row.cancellationReason?.substring(0, 25)}...
            </Typography>
          </Box>
        ),
      },
      {
        ...
        renderCell: (params) => (
          ...
          >
            ...
            >
              Refund: â‚¹{params.row.refundAmount?.toFixed(0)}
            </Typography>
          </Box>
        ),
      },
  ...
  return (
    <PageContainer
      ...
      description="Manage cancelled orders and process refunds"
    >
      <Breadcrumb title="Cancelled Orders" items={BCrumb} />
        ...
        >
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Orders cancelled by customers or partners requiring refund processing (
            ...
            <Grid container spacing={2} sx={{ mt: 1 }}>
              <Grid item xs={12}>
                ...
                >
                  ...
                  <MenuItem value="refund-processed">Mark Refund as Processed</MenuItem>
                  <MenuItem value="refund-pending">Update Refund Status</MenuItem>
                  <MenuItem value="partial-refund">Process Partial Refund</MenuItem>
                  <MenuItem value="no-refund">Mark as No Refund Required</MenuItem>
                  <MenuItem value="investigation">Start Investigation</MenuItem>
                </CustomSelect>
              </Grid>
              <Grid item xs={12}>
                ...
                <CustomTextField
                  ...
                  onChange={handleEditInputChange}
                  placeholder="Add refund processing details or investigation notes..."
                  multiline
                  rows={3}
                  fullWidth
                />
