...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Confirmed Appointments- Verified Partners' }];
...
const WorkInProgress = () => {
  ...
  const fetchBookings = async () => {
    ...
    try {
      const response = await axios.post(
        ...
        { status: 'appointmentConfirmedByProvider' },
        {
          headers: {
  ...
  return (
    <PageContainer
      title="Confirmed Appointment - Verified Partners"
      description="Monitor and manage premium services currently being performed by verified partners"
    >
      <Breadcrumb title=" Confirmed Appointment  - Verified Partners" items={BCrumb} />
