...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Add On Demand Worker' }];
...
const AddOnDemandWorkers = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post(URLS.AddOnDemandWorker, formData, {
        headers: {
  ...
  return (
    <PageContainer
      title="Add On Demand Worker"
      description="Manage Add On Demand Worker for your platform"
    >
      <Breadcrumb title="Add On Demand Worker" items={BCrumb} />
      ...
      <form onSubmit={handleSubmit}>
        <ParentCard title="Create On Demand Worker">
...
export default AddOnDemandWorkers;
