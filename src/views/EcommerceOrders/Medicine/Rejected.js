...
import { IconEye, IconAnalyze, IconPill, IconAlertTriangle, IconRefresh } from '@tabler/icons-react';
...
const BCrumb = [
  { to: '/', title: 'Home' },
  { title: 'Rejected Orders - Medicines' }
];
...
// Mock Data for Rejected Medicine Orders
const rejectedOrdersData = [
  {
    _id: '1',
    orderId: 'MED-ORD-2024-007',
    customerName: 'Aruna Krishnan',
    customerPhone: '+91 98765 43215',
    customerEmail: 'aruna.krishnan@email.com',
    pharmacyName: 'CityMed Pharmacy',
    pharmacyImage: '/images/pharmacies/citymed.jpg',
    pharmacistName: 'Dr. Vishnu Kumar',
    prescriptionId: 'RX-2024-007',
    medicineType: 'Specialized Oncology Medicines',
    orderItems: 2,
    ...
    rejectionReason: 'Specialized oncology medicines require prior authorization and special handling certification',
    alternativePharmaciesAvailable: 2,
    reassignmentStatus: 'in-progress',
    prescriptionVerificationIssue: true,
    patientSafetyFlag: true,
    alternativeMedicineAvailable: false,
    urgencyLevel: 'urgent',
    specialHandlingRequired: true,
  },
  {
    _id: '2',
    orderId: 'MED-ORD-2024-014',
    customerName: 'Manjesh Gupta',
    customerPhone: '+91 87654 32114',
    customerEmail: 'manjesh.gupta@email.com',
    pharmacyName: 'QuickHeal Pharmacy',
    pharmacyImage: '/images/pharmacies/quickheal.jpg',
    pharmacistName: 'Dr. Rekha Patel',
    prescriptionId: 'RX-2024-014',
    medicineType: 'Controlled Substance (Schedule II)',
    orderItems: 1,
    ...
    rejectionReason: 'Controlled substance requires additional documentation and DEA verification not completed',
    alternativePharmaciesAvailable: 4,
    reassignmentStatus: 'completed',
    prescriptionVerificationIssue: true,
    patientSafetyFlag: false,
    alternativeMedicineAvailable: true,
...
// Main Rejected Orders Component for Medicines
const RejectedOrders = () => {
  ...
  const getPatientSafetyChip = (hasFlag) => {
  ...
  const getSpecialHandlingChip = (required) => {
  ...
  const columns = useMemo(
    () => [
        ...
        renderCell: (params) => (
          <Box sx={{ py: 1 }}>
            ...
            <Typography variant="caption" color="info.main" sx={{ display: 'block' }}>
              Alt: {params.row.alternativeMedicineAvailable ? 'Available' : 'Not Available'}
            </Typography>
          </Box>
        ),
      },
        ...
        renderCell: (params) => (
          <Box sx={{ py: 1 }}>
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
              {getPatientSafetyChip(params.row.patientSafetyFlag)}
              {getSpecialHandlingChip(params.row.specialHandlingRequired)}
            </Box>
          </Box>
        ),
      },
      ...
      {
        field: 'alternativePharmacies',
        headerName: 'Alternatives',
        width: 130,
        renderCell: (params) => getAlternativePharmaciesDisplay(params.row.alternativePharmaciesAvailable),
      },
      {
  ...
  return (
    <PageContainer
      title="Rejected Orders - Medicines"
      description="Manage medicine orders rejected by pharmacies with patient safety and compliance handling"
    >
      <Breadcrumb title="Rejected Orders - Medicines" items={BCrumb} />
      ...
      >
        ...
        >
          <Box>
            <Typography variant="h6">Rejected Orders - Medicines</Typography>
            <Typography variant="body2" color="text.secondary">
              Medicine orders rejected by pharmacies requiring immediate reassignment and compliance handling ({filteredData.length} orders)
            </Typography>
          </Box>
      ...
      <Dialog open={openModal} onClose={handleCloseModal} maxWidth="sm" fullWidth>
        <DialogTitle>Reassign Medicine Order</DialogTitle>
            ...
            <Grid container spacing={2} sx={{ mt: 1 }}>
              <Grid item xs={12}>
                ...
                >
                  ...
                  <MenuItem value="reassign-specialized-pharmacy">Reassign to Specialized Pharmacy</MenuItem>
                  <MenuItem value="resolve-prescription-issue">Resolve Prescription Verification</MenuItem>
                  <MenuItem value="auto-reassign-available">Auto-assign to Available Pharmacy</MenuItem>
                  ...
                  <MenuItem value="cancel-safety-concern">Cancel Due to Safety Concerns</MenuItem>
                </CustomSelect>
              </Grid>
              <Grid item xs={12}>
                ...
                <CustomTextField
                  ...
                  onChange={handleEditInputChange}
                  placeholder="Add reassignment details, prescription verification notes, safety concerns, or alternative medicine suggestions..."
                  multiline
                  rows={3}
                  fullWidth
                />
