...
import { IconEye, IconAnalyze, IconPill } from '@tabler/icons-react';
...
const BCrumb = [
  { to: '/', title: 'Home' },
  { title: 'Pending Orders - Medicines' }
];
...
// Mock Data for Pending Medicine Orders
const pendingOrdersData = [
  {
    _id: '1',
    orderId: 'MED-ORD-2024-001',
    customerName: 'Rajesh Kumar',
    customerPhone: '+91 98765 43210',
    customerEmail: 'rajesh.kumar@email.com',
    pharmacyName: 'HealthPlus Pharmacy',
    pharmacyImage: '/images/pharmacies/healthplus.jpg',
    prescriptionId: 'RX-2024-001',
    medicineType: 'Prescription Medicines',
    orderItems: 3,
  ...
  {
    _id: '2',
    orderId: 'MED-ORD-2024-002',
    customerName: 'Priya Sharma',
    customerPhone: '+91 87654 32109',
    customerEmail: 'priya.sharma@email.com',
    pharmacyName: 'MediCare Express',
    pharmacyImage: '/images/pharmacies/medicare.jpg',
    prescriptionId: 'RX-2024-002',
    medicineType: 'OTC Medicines',
    orderItems: 5,
    orderDate: '2024-08-20',
    orderTime: '2:00 PM',
    orderValue: 450.00,
...
// Main Pending Orders Component for Medicines
const PendingOrders = () => {
  ...
  return (
    <PageContainer
      title="Pending Orders - Medicines"
      description="Manage pending medicine orders awaiting pharmacy response"
    >
      <Breadcrumb title="Pending Orders - Medicines" items={BCrumb} />
      ...
      >
        ...
        >
          <Box>
            <Typography variant="h6">Pending Orders - Medicines</Typography>
            <Typography variant="body2" color="text.secondary">
              Medicine orders awaiting pharmacy response and prescription verification ({filteredData.length} orders)
            </Typography>
          </Box>
      ...
      <Dialog open={openModal} onClose={handleCloseModal} maxWidth="sm" fullWidth>
        <DialogTitle>Take Action on Medicine Order</DialogTitle>
            ...
            <Grid container spacing={2} sx={{ mt: 1 }}>
              <Grid item xs={12}>
                ...
                >
                  ...
                  <MenuItem value="rejected">Reject Order (Medicine Unavailable)</MenuItem>
                  <MenuItem value="cancelled">Cancel Order</MenuItem>
                  <MenuItem value="prescription-required">Request Prescription Clarification</MenuItem>
              ...
              <Grid item xs={12}>
                ...
                <CustomTextField
                  ...
                  onChange={handleEditInputChange}
                  placeholder="Add comments about medicine availability, prescription issues, or other concerns..."
                  multiline
                  rows={3}
                  fullWidth
                />
