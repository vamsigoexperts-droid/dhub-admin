...
function Units() {
  ...
  const getData = () => {
    ...
    axios
      ...
      .then((res) => setData(res.data.units || []))
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Box display="flex" gap={1}>
          {rolesAndPermission.medicine_units_edit === true ||
          ...
          {rolesAndPermission.medicine_units_delete === true ||
          rolesAndPermission.accessAll === true ? (
            <>
              <Button
                size="small"
  ...
  return (
    <PageContainer title="Units" description="this is Units page">
        ...
        <CardHeader
          ...
          action={
            <Box display="flex" gap={2} alignItems="center" flexWrap="wrap">
              ...
              {rolesAndPermission.medicine_units_add === true ||
              rolesAndPermission.accessAll === true ? (
                <>
                  <Button
                    variant="contained"
