...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Neck Type' }];
...
function NeckType() {
  ...
  return (
    <PageContainer title="Neck Type" description="This is Neck Type page">
      <Breadcrumb title="Neck Type" items={BCrumb} />
      {showAdd && (
        ...
        <CardHeader
          ...
          action={
            <Box display="flex" gap={2} alignItems="center" flexWrap="wrap">
              ...
              />{' '}
              {rolesAndPermission.neck_type_add === true ||
