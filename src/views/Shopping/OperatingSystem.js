...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Country Origin Type' }];

function CountryOriginType() {
  ...
  const handleAddSubmit = (e) => {
    ...
    const formData = {
      name: form.name,
      flagType: 'shopping',
      dropDownType: 'countryOriginType',
    };
    axios
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Box display="flex" gap={1}>
          {rolesAndPermission.operating_system_edit === true ||
          ...
          {rolesAndPermission.operating_system_delete === true ||
          rolesAndPermission.accessAll === true ? (
            <>
              <Button
                size="small"
  ...
  return (
    <PageContainer title="Country Origin Type" description="This is Country Origin Type page">
      <Breadcrumb title="Country Origin Type" items={BCrumb} />
      {showAdd && (
      ...
      <Card sx={{ padding: 0, mt: 3 }} elevation={9} variant="outlined">
        <CardHeader
          title="Country Origin Type List"
          action={
            <Box display="flex" gap={2} alignItems="center" flexWrap="wrap">
              ...
              />{' '}
              {rolesAndPermission.operating_system_add === true ||
              rolesAndPermission.accessAll === true ? (
                <>
                  <Button
                    variant="contained"
                    ...
                    disabled={loading}
                  >
                    <IconPlus /> Create Country Origin Type
                  </Button>
                </>
              ) : (
                <></>
...
export default CountryOriginType;
