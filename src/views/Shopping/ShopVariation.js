...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Shop Variation' }];
...
function SizeType() {
  ...
  return (
    <PageContainer title="Shop Variation" description="This is Size Type page">
      <Breadcrumb title="Shop Variation" items={BCrumb} />
      {showAdd && (
              ...
              rolesAndPermission.accessAll === true ? (
                <>
                  <Button
                    ...
                    disabled={loading}
                  >
                    <IconPlus /> Create Shop Variation
                  </Button>
                </>
              ) : (
                <></>
