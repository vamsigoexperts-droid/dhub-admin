...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Size Type' }];
...
function SizeType() {
  ...
  return (
    <PageContainer title="Size Type" description="This is Size Type page">
      <Breadcrumb title="Size Type" items={BCrumb} />
      {showAdd && (
