...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Type Of Material' }];
...
function MaterialType() {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Box display="flex" gap={1}>
          {rolesAndPermission.material_type_edit === true ||
          ...
          {rolesAndPermission.material_type_delete === true ||
          rolesAndPermission.accessAll === true ? (
            <>
              <Button
                size="small"
  ...
  return (
    <PageContainer title="Type Of Material" description="This is Type Of Material page">
      <Breadcrumb title="Type Of Material" items={BCrumb} />
      {showAdd && (
        ...
        <CardHeader
          ...
          action={
            <Box display="flex" gap={2} alignItems="center" flexWrap="wrap">
              ...
              />{' '}
              {rolesAndPermission.material_type_add === true ||
              rolesAndPermission.accessAll === true ? (
                <>
                  <Button
                    variant="contained"
                    ...
                    disabled={loading}
                  >
                    <IconPlus /> Create Type Of Material
                  </Button>
                </>
              ) : (
                <></>
