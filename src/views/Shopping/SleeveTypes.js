...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Sleeve Type' }];
...
function SleeveType() {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Box display="flex" gap={1}>
          ...
          {rolesAndPermission.sleeve_type_delete === true ||
  ...
  return (
    <PageContainer title="Sleeve Type" description="This is Sleeve Type page">
      <Breadcrumb title="Sleeve Type" items={BCrumb} />
      {showAdd && (
        ...
        <CardHeader
          ...
          action={
            <Box display="flex" gap={2} alignItems="center" flexWrap="wrap">
              ...
              />
              {rolesAndPermission.sleeve_type_add === true ||
              rolesAndPermission.accessAll === true ? (
                <>
                  <Button
                    variant="contained"
