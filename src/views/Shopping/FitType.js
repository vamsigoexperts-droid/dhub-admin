...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Fit Type' }];
...
function FitType() {
  ...
  return (
    <PageContainer title="Fit Type" description="This is Fit Type page">
      <Breadcrumb title="Fit Type" items={BCrumb} />
      {showAdd && (
