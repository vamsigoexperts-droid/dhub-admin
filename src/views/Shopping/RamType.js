...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Ram Type' }];
...
function RamType() {
  ...
  return (
    <PageContainer title="Ram Type" description="This is Ram Type page">
      <Breadcrumb title="Ram Type" items={BCrumb} />
      {showAdd && (
