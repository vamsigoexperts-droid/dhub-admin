...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Storage Type' }];
...
function StorageType() {
  ...
  return (
    <PageContainer title="Storage Type" description="This is Storage Type page">
      <Breadcrumb title="Storage Type" items={BCrumb} />
      {showAdd && (
