...
const BCrumb = [{ to: '/', title: 'Home' }, { title: 'Color Type' }];
...
function ColorType() {
  ...
  return (
    <PageContainer title="Color Type" description="This is Color Type page">
      <Breadcrumb title="Color Type" items={BCrumb} />
      {showAdd && (
